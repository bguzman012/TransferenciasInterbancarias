...
/***/ "+pRu":
/*!********************************************!*\
  !*** ./src/app/services/loggin.service.ts ***!
  \********************************************/
/*! exports provided: LogginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LogginService", function() { return LogginService; });
...
let LogginService = class LogginService {
    constructor(http) {
        this.http = http;
        //dwenfweeu
        this.path = 'http://34.94.191.122:8081/loggin';
        this.path2 = 'http://34.94.191.122:8081/tockenizar';
        this.path3 = 'http://34.94.191.122:8081/bancos';
    }
    //se hace una solicitud get para el logeo
    getUser(user) {
        return this.http.get(this.path + "?correo=" + user.correo + "&contra=" + user.contra);
    }
...
LogginService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
LogginService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
